  ...
  form.addEventListener("submit", async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        // Registration succeeded and the server logged us in — go to the
        // dashboard instead of just sitting on the form.
        submitBtn.textContent = "Redirecting…";
        window.location.href = data.redirect || "dashboard/index.php";
        return; // don't fall through to the "finally" re-enable below
      } else {
